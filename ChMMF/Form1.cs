...
namespace ChMMF
{
    public partial class Form1 : Form
    {
        ...
        {
            double TN = double.Parse(textBox5.Text);
            int N = int.Parse(textBox6.Text);
            NumGraphs = N;
            double T = double.Parse(textBox4.Text);
            PoohMathParser.MathExpression f = new PoohMathParser.MathExpression(textBox3.Text);
            PoohMathParser.MathExpression u0 = new PoohMathParser.MathExpression(textBox2.Text);
            PoohMathParser.MathExpression q = new PoohMathParser.MathExpression(textBox1.Text);
